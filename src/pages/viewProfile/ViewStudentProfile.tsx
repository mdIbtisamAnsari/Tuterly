      ...
      <div className="mx-auto max-w-6xl">
        {student ? (
              ...
              <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                <div className="space-y-6">
                  <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
                    ...
                    <p className="mt-3 text-base leading-7 text-slate-300">
                      {student.bio || "No biography added yet."}
                    </p>
                  </div>
                ...
                <div className="space-y-4 rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-base font-medium text-white">
                      {student.rate ? `$${student.rate}` : "Rate not set"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-10 text-center shadow-2xl shadow-sky-950/20">
            <h2 className="text-2xl font-semibold text-white">Student not found</h2>
            <p className="mt-2 text-slate-400">The requested student profile could not be loaded.</p>
          </div>
        )}
      </div>
    </div>
